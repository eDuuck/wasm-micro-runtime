...
void *attack_page1 = allocate_pages(PAGE_SIZE, 0);
void *attack_page2 = allocate_pages(PAGE_SIZE, 0);
uint64_t phys1 = virt_to_phys(attack_page1);
uint64_t phys2 = virt_to_phys(attack_page2);
if (phys1 == 0 || phys2 == 0) {
